...
const posts = [
  { src: '/images/confeitaria/tartlets-piped.webp', span: 'col-span-1 row-span-1' },
  { src: '/images/doces/trufas-chocolate.webp', span: 'col-span-1 row-span-2' },
  { src: '/images/macarons/macarons-rosa-evento.webp', span: 'col-span-1 row-span-1' },
  { src: '/images/confeitaria/profiteroles-pistache.webp', span: 'col-span-1 row-span-1' },
  { src: '/images/doces/brigadeiros-gourmet.webp', span: 'col-span-1 row-span-2' },
  { src: '/images/confeitaria/eclairs-rosa.webp', span: 'col-span-1 row-span-1' },
  { src: '/images/macarons/macaron-caramelo.webp', span: 'col-span-1 row-span-1' },
  { src: '/images/confeitaria/milefeuille.webp', span: 'col-span-1 row-span-1' },
  { src: '/images/eventos/mesa-casamento.webp', span: 'col-span-1 row-span-1' },
  { src: '/images/doces/brigadeiros-pistache.webp', span: 'col-span-1 row-span-2' },
  ...
  { src: '/images/flores/arranjo-cora.webp', span: 'col-span-1 row-span-2' },
