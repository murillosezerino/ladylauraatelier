    ...
    <section id="nossas-casas" className="py-24 px-6 relative overflow-hidden bg-white">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="text-center mb-14 reveal">
          ...
          <div className={`max-w-2xl mx-auto space-y-4 font-sans text-[0.95rem] leading-relaxed transition-colors duration-500 ${hasHover ? 'text-white/80' : 'text-ink-2'}`}>
        ...
        {/* Cards - always solid, never change */}
